...
variable "db_instance_class" {
  ...
  type        = string
  default     = "db.t4g.small" # Larger for production
}
...
variable "web_domain_name" {
  description = "Domain name for web app (e.g., app.example.com)"
  type        = string
}

variable "vendors_domain_name" {
  description = "Domain name for vendors app (e.g., vendors.example.com)"
  type        = string
}
...
variable "stripe_publishable_key" {
  description = "Stripe publishable key (LIVE key for production)"
  type        = string
  default     = ""
}
