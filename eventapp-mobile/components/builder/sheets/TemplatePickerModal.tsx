...
const s = StyleSheet.create({
  ...
  pillsContent:  { paddingHorizontal: 14, paddingVertical: 10, gap: 8, flexDirection: 'row' },
  pill:          { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20, backgroundColor: 'rgba(255,255,255,0.06)', borderWidth: 1, borderColor: 'transparent' },
