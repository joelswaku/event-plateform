// Ported from web/src/lib/styleTemplates.js
...
export interface StyleTemplate {
  ...
  eventTypes: string[];
  description: string;
  design: { colors: { bg: string; accent: string; dark: string; text: string } };
  assets: { hero_image: string; cover_image: string; gallery_images: string[] };
  sections: { type: string; config: Record<string, unknown> }[];
}

export const TEMPLATE_CATEGORIES: Record<string, { label: string; emoji: string; types: string[] }> = {
...
export const CATEGORY_ORDER = ['SOCIAL', 'CORPORATE', 'ENTERTAINMENT', 'LIFE', 'RELIGIOUS'] as const;

export function getCategoryForType(eventType: string): string | null {
...
export const STYLE_TEMPLATES: StyleTemplate[] = [
  ...
  {
    id: 'classic-grand', name: 'Classic Grand', style: 'CLASSIC', tier: 'free',
    category: 'LIFE', eventTypes: ['wedding','engagement','anniversary'],
    ...
    assets: {
      ...
      gallery_images: ['https://images.unsplash.com/photo-1511285560929-80b456fea0bc?w=800&q=80','https://images.unsplash.com/photo-1478146059778-26b43b8b0a86?w=800&q=80','https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=800&q=80','https://images.unsplash.com/photo-1469371670807-013ccf25f16a?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'classic-intimate', name: 'Classic Intimate', style: 'CLASSIC', tier: 'free',
    category: 'SOCIAL', eventTypes: ['birthday','anniversary','graduation','private_party','family_reunion'],
  ...
  {
    id: 'classic-complete', name: 'Classic Complete', style: 'CLASSIC', tier: 'free',
    category: 'LIFE', eventTypes: ['wedding','engagement'],
    ...
    assets: {
      ...
      gallery_images: ['https://images.unsplash.com/photo-1519741497674-611481863552?w=800&q=80','https://images.unsplash.com/photo-1469371670807-013ccf25f16a?w=800&q=80','https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=800&q=80','https://images.unsplash.com/photo-1478146059778-26b43b8b0a86?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'classic-birthday', name: 'Birthday Classic', style: 'CLASSIC', tier: 'free',
    category: 'SOCIAL', eventTypes: ['birthday','private_party'],
    ...
    assets: {
      ...
      gallery_images: ['https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=800&q=80','https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'classic-graduation', name: 'Graduation Day', style: 'CLASSIC', tier: 'free',
    category: 'SOCIAL', eventTypes: ['graduation'],
  ...
  {
    id: 'classic-corporate', name: 'Professional Classic', style: 'CLASSIC', tier: 'free',
    category: 'CORPORATE', eventTypes: ['conference','seminar','meeting','corporate','corporate_event'],
  ...
  {
    id: 'elegant-blossom', name: 'Blossom', style: 'ELEGANT', tier: 'premium',
    category: 'LIFE', eventTypes: ['wedding','engagement','anniversary'],
    ...
    assets: {
      ...
      gallery_images: ['https://images.unsplash.com/photo-1561369036-c9e2bcca6d52?w=800&q=80','https://images.unsplash.com/photo-1490750967868-88df5691cc84?w=800&q=80','https://images.unsplash.com/photo-1444021465936-c6ca81d39b84?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'elegant-rosegarden', name: 'Rose Garden', style: 'ELEGANT', tier: 'premium',
    category: 'SOCIAL', eventTypes: ['birthday','anniversary','baby_shower','bridal_shower'],
  ...
  {
    id: 'elegant-ivorydream', name: 'Ivory Dream', style: 'ELEGANT', tier: 'premium',
    category: 'LIFE', eventTypes: ['wedding','engagement'],
  ...
  {
    id: 'elegant-birthday', name: 'Chic Birthday', style: 'ELEGANT', tier: 'premium',
    category: 'SOCIAL', eventTypes: ['birthday','anniversary','bridal_shower'],
    ...
    assets: {
      ...
      gallery_images: ['https://images.unsplash.com/photo-1527529482837-4698179dc6ce?w=800&q=80','https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'elegant-theater', name: 'Stage & Screen', style: 'ELEGANT', tier: 'premium',
    category: 'ENTERTAINMENT', eventTypes: ['theater','live_show','exhibition','comedy'],
  ...
  {
    id: 'modern-bold', name: 'Bold Statement', style: 'MODERN', tier: 'premium',
    category: 'CORPORATE', eventTypes: ['conference','seminar','product_launch','networking','corporate_event','corporate'],
    description: 'Geometric, left-aligned typography with strong indigo accents and a sharp grid layout.',
    design: { colors: { bg: '#F4F4F8', accent: '#5B5FED', dark: '#0A0A14', text: '#0F0F1A' } },
    assets: {
      ...
      gallery_images: ['https://images.unsplash.com/photo-1523580494863-6f3031224c94?w=800&q=80','https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'modern-clean', name: 'Clean Cut', style: 'MODERN', tier: 'premium',
    category: 'CORPORATE', eventTypes: ['meeting','workshop','training','seminar'],
  ...
  {
    id: 'modern-pro', name: 'Urban Pro', style: 'MODERN', tier: 'premium',
    category: 'CORPORATE', eventTypes: ['conference','seminar','product_launch','corporate','corporate_event'],
    ...
    assets: {
      ...
      gallery_images: ['https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80','https://images.unsplash.com/photo-1523580494863-6f3031224c94?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'modern-concert', name: 'Neon Nights', style: 'MODERN', tier: 'premium',
    category: 'ENTERTAINMENT', eventTypes: ['concert','live_show','nightclub','festival','sports'],
    ...
    assets: {
      ...
      gallery_images: ['https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=800&q=80','https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800&q=80','https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'modern-launch', name: 'Product Drop', style: 'MODERN', tier: 'premium',
    category: 'CORPORATE', eventTypes: ['product_launch','networking','company_party'],
  ...
  {
    id: 'modern-networking', name: 'Connect & Grow', style: 'MODERN', tier: 'premium',
    category: 'CORPORATE', eventTypes: ['networking','meeting','company_party','workshop'],
  ...
  {
    id: 'minimal-whitespace', name: 'White Space', style: 'MINIMAL', tier: 'premium',
    category: 'CORPORATE', eventTypes: ['meeting','seminar','training','workshop'],
  ...
  {
    id: 'minimal-pureform', name: 'Pure Form', style: 'MINIMAL', tier: 'premium',
    category: 'CORPORATE', eventTypes: ['conference','seminar','training','corporate','corporate_event'],
  ...
  {
    id: 'minimal-essential', name: 'Essential', style: 'MINIMAL', tier: 'premium',
    category: 'CORPORATE', eventTypes: ['conference','seminar','networking','workshop','product_launch'],
  ...
  {
    id: 'minimal-exhibition', name: 'Gallery Opening', style: 'MINIMAL', tier: 'premium',
    category: 'ENTERTAINMENT', eventTypes: ['exhibition','theater','live_show'],
    ...
    assets: {
      ...
      gallery_images: ['https://images.unsplash.com/photo-1577720580479-7d839d829c73?w=800&q=80','https://images.unsplash.com/photo-1461360370896-922624d12aa1?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'minimal-funeral', name: 'In Memoriam', style: 'MINIMAL', tier: 'premium',
    category: 'LIFE', eventTypes: ['funeral'],
  ...
  {
    id: 'luxury-obsidian', name: 'Obsidian', style: 'LUXURY', tier: 'premium',
    category: 'SOCIAL', eventTypes: ['private_party','birthday','anniversary','gala'],
    ...
    assets: {
      ...
      gallery_images: ['https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=800&q=80','https://images.unsplash.com/photo-1551882547-ff40c4a49ce5?w=800&q=80','https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'luxury-darkopulence', name: 'Dark Opulence', style: 'LUXURY', tier: 'premium',
    category: 'ENTERTAINMENT', eventTypes: ['concert','nightclub','private_party','gala'],
    ...
    assets: {
      ...
      gallery_images: ['https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&q=80','https://images.unsplash.com/photo-1551882547-ff40c4a49ce5?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'luxury-goldreserve', name: 'Gold Reserve', style: 'LUXURY', tier: 'premium',
    category: 'LIFE', eventTypes: ['wedding','engagement','anniversary'],
  ...
  {
    id: 'luxury-summit', name: 'Executive Summit', style: 'LUXURY', tier: 'premium',
    category: 'CORPORATE', eventTypes: ['conference','product_launch','networking','corporate','corporate_event'],
  ...
  {
    id: 'luxury-concert', name: 'Grand Spectacle', style: 'LUXURY', tier: 'premium',
    category: 'ENTERTAINMENT', eventTypes: ['concert','live_show','theater','nightclub'],
    description: 'A cinematic concert experience — sold-out energy, VIP tiers, and gold accents.',
    design: { colors: { bg: '#0D0C0A', accent: '#D4AF6F', dark: '#0D0C0A', text: '#EDE8DF' } },
    assets: {
      hero_image:    'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=1400&q=85',
      cover_image:   'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=640&q=80',
      gallery_images: ['https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=800&q=80','https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'fun-partytime', name: 'Party Time', style: 'FUN', tier: 'premium',
    category: 'SOCIAL', eventTypes: ['birthday','private_party','gender_reveal','baby_shower'],
    description: 'Warm amber energy with big countdown and bold gallery. Born to celebrate.',
    design: { colors: { bg: '#FFFBF0', accent: '#F59E0B', dark: '#1C1407', text: '#1C2333' } },
    assets: {
      ...
      gallery_images: ['https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=800&q=80','https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800&q=80','https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'fun-celebration', name: 'Celebration', style: 'FUN', tier: 'premium',
    category: 'SOCIAL', eventTypes: ['birthday','graduation','family_reunion','anniversary'],
  ...
  {
    id: 'fun-festival', name: 'Festival Vibes', style: 'FUN', tier: 'premium',
    category: 'ENTERTAINMENT', eventTypes: ['festival','concert','sports','live_show'],
    ...
    assets: {
      ...
      gallery_images: ['https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=800&q=80','https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=800&q=80','https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'fun-birthday-bash', name: 'Birthday Bash', style: 'FUN', tier: 'premium',
    category: 'SOCIAL', eventTypes: ['birthday','private_party','graduation'],
    description: 'Bold, colorful, and energetic — the ultimate birthday party template.',
    design: { colors: { bg: '#FFFBF0', accent: '#F59E0B', dark: '#1C1407', text: '#1C2333' } },
    assets: {
      hero_image:    'https://images.unsplash.com/photo-1527529482837-4698179dc6ce?w=1400&q=85',
      cover_image:   'https://images.unsplash.com/photo-1527529482837-4698179dc6ce?w=640&q=80',
      gallery_images: ['https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=800&q=80','https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800&q=80'],
    },
    sections: [
  ...
  {
    id: 'fun-company-party', name: 'Team Bash', style: 'FUN', tier: 'premium',
    category: 'CORPORATE', eventTypes: ['company_party','networking','corporate_event'],
  ...
  {
    id: 'fun-comedy', name: 'Comedy Night', style: 'FUN', tier: 'premium',
    category: 'ENTERTAINMENT', eventTypes: ['comedy','live_show','nightclub'],
