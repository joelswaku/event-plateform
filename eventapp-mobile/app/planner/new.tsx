    ...
    if (next < QUESTIONS.length) {
      ...
      setTimeout(async () => {
        ...
        const res = await createProject({
          ...
          eventDate:   selectedEvent?.starts_at     || selectedEvent?.starts_at_utc || null,
          eventEndDate:selectedEvent?.ends_at       || selectedEvent?.ends_at_utc || null,
          guestCount:  newAnswers.guestCount        || null,
          totalBudget: newAnswers.totalBudget       || null,
          currency:    newAnswers.currency          || 'USD',
          venue:       newAnswers.venue || selectedEvent?.venue_name || selectedEvent?.venue_address || null,
          city:        selectedEvent?.city          || null,
          country:     selectedEvent?.country       || null,
