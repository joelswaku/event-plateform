...
const styles = StyleSheet.create({
  ...
  statLabel:   { fontSize: 10, color: 'rgba(255,255,255,0.72)', marginTop: 2, fontWeight: '800' },
  ...
  cardSub:    { fontSize: 13, color: 'rgba(255,255,255,0.76)', marginTop: -8, fontWeight: '600' },
  fields:     { gap: 14 },
