        ...
        <div className="flex items-center gap-2">
          ...
          {isSubscribed ? (
            ...
            <button
              ...
              className="hidden items-center gap-1.5 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 px-3 py-1.5 text-xs font-semibold text-white hover:opacity-90 sm:flex"
            >
          ...
          <div className="flex items-center gap-2 pl-2 border-l border-gray-200 dark:border-gray-800">
            <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 text-xs font-bold text-white select-none">
              {initials}
            </div>
            <button
              onClick={handleLogout}
              className="rounded-xl p-2 text-gray-500 hover:bg-red-50 hover:text-red-600 dark:text-gray-400 dark:hover:bg-red-950/30 dark:hover:text-red-400 transition-colors"
              title="Sign out"
            >
