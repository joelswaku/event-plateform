...
//     section_type: "ABOUT",
//     title: "About this event",
//     body: "Tell your guests about this event.",
//     config: {},
//   },
//   CTA: {
//     section_type: "CTA",
...
//   const role = String(result.rows[0].role).toUpperCase();
//   const allowed = ["OWNER", "ADMIN", "MANAGER", "EVENT_MANAGER", "EDITOR"];
...
// function validatePagePayload(payload = {}) {
//   if (payload.public_url !== undefined && payload.public_url !== null) {
//     if (!String(payload.public_url).trim()) {
//       throw new AppError("public_url cannot be empty", 400);
//     }
//   }

//   if (payload.seo_title !== undefined && payload.seo_title !== null) {
//     if (String(payload.seo_title).trim().length > 255) {
//       throw new AppError("seo_title too long (max 255 chars)", 400);
//     }
//   }
// }
...
//     }
//   } else {
//     const sectionType = normalizeSectionType(payload.section_type);
//     if (!sectionType) {
//       errors.push("section_type is required");
//     }
//   }
...
//   if (!normalizeText(payload.media_type)) {
//     errors.push("media_type is required");
//   }

//   if (!normalizeText(payload.file_url)) {
...
//     is_published: Boolean(page.published_at),
...
//     await assertOrganizationEventPermission(client, organizationId, userId);
//     const event = await assertEventExists(client, eventId, organizationId);
//     await getOrCreateEventPage(client, event);
...
//       [
//         eventId,
//         normalizeText(payload.public_url) ?? buildDefaultPublicUrl(event),
//         normalizeText(payload.seo_title),
//         normalizeText(payload.seo_description),
//       ]
//     );
...
//     await client.query("COMMIT");
//     return mapBuilderPage(result.rows[0]);
//   } catch (error) {
//     await client.query("ROLLBACK");
//     throw error;
//   } finally {
...
//         body: normalizeText(payload.body),
//         position_order:
//           payload.position_order ?? nextPositionResult.rows[0].next_position,
//         config: ensureObject(payload.config, "config"),
//       };
//     }
...
//       [
//         eventId,
//         finalPayload.section_type,
//         finalPayload.title,
//         finalPayload.body,
//         ensurePositiveInteger(finalPayload.position_order, "position_order"),
...
//       position_order:
//         payload.position_order !== undefined
//           ? ensurePositiveInteger(payload.position_order, "position_order")
//           : existing.position_order,
//       is_visible:
//         payload.is_visible !== undefined ? Boolean(payload.is_visible) : existing.is_visible,
//       config:
...
//       ensurePositiveInteger(item.position_order, "position_order");
