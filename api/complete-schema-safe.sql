...
CREATE TYPE IF NOT EXISTS public.activity_level AS ENUM (
    'INFO',
    'WARNING',
    'CRITICAL'
);
...
CREATE TYPE IF NOT EXISTS public.checkin_method AS ENUM (
    'MANUAL',
    'QR'
);
...
CREATE TYPE IF NOT EXISTS public.discount_type AS ENUM (
    'PERCENTAGE',
    'FIXED_AMOUNT'
);
...
CREATE TYPE IF NOT EXISTS public.event_member_role AS ENUM (
    'OWNER',
    'ADMIN',
    'MANAGER',
    'CHECKIN_AGENT',
...
CREATE TYPE IF NOT EXISTS public.event_visibility AS ENUM (
    'PUBLIC',
    'PRIVATE',
    'UNLISTED'
);
...
CREATE TYPE IF NOT EXISTS public.invitation_channel AS ENUM (
    'EMAIL',
    'SMS',
    'WHATSAPP',
    'LINK'
...
CREATE TYPE IF NOT EXISTS public.media_type AS ENUM (
    'IMAGE',
    'VIDEO',
    'DOCUMENT',
    'AUDIO'
...
CREATE TYPE IF NOT EXISTS public.message_provider AS ENUM (
    'BREVO',
    'TWILIO',
    'WHATSAPP_CLOUD',
    'INTERNAL',
...
CREATE TYPE IF NOT EXISTS public.qr_status AS ENUM (
    'ACTIVE',
    'USED',
    'REVOKED',
    'EXPIRED'
...
CREATE TYPE IF NOT EXISTS public.ticket_type_kind AS ENUM (
    'FREE',
    'PAID',
    'DONATION'
);
...
CREATE TYPE IF NOT EXISTS public.upload_owner_type AS ENUM (
    'USER',
    'ORGANIZATION',
    'EVENT',
    'VENDOR'
...
CREATE TYPE IF NOT EXISTS public.user_status AS ENUM (
    'ACTIVE',
    'PENDING',
    'SUSPENDED',
    'DELETED'
...
CREATE TYPE IF NOT EXISTS public.vendor_status AS ENUM (
    'PENDING',
    'APPROVED',
    'REJECTED',
    'SUSPENDED'
...
CREATE TABLE IF NOT EXISTS public.ai_chatbot_sessions (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.event_dashboard_widgets (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    event_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.event_donation_config (
    event_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.event_donations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    event_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.event_tag_map (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    event_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.guest_qr_passes (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    guest_id uuid NOT NULL,
    event_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.planner_budget_items (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    project_id uuid NOT NULL,
    title character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.planner_timeline_items (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    project_id uuid NOT NULL,
    title text NOT NULL,
